    ...
    <tr>
      <td valign="bottom" style="padding: 20px 0 20px 20px;text-align: left;">
        <a href="{{ url() }}" style="display:inline-block;" target="_blank">
          <img src="{{ url() . '/assets/img/logo.png'}}" alt="Licenser" border="0">
        </a>
      </td>
          ...
          <tr>
            ...
            <h1 class="slogan">¡Enhorabuena!</h1>
            	<h3 style="font-weight: 600; font-size: 25px;">
                        ...
                        Hemos finalizado el proceso, estos son los datos de tu licencia:
              </h3>
              ...
              <hr>
            	<p class="text">
                  ...
                  <br>
                  <div class="col-md-12">
                    Para descargar el plugin haz click en el siguiente enlace, pero hazlo rapido el enlace vencera.
                    <a href="{{ URL::to('download/plugin', array($expiration->token)) }}">Descargar Plugin</a>
                  <div>
